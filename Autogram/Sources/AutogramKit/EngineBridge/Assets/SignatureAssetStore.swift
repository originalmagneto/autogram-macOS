...
public enum SignatureAssetStoreError: Error {
...
public struct SignatureAssetStore {
    ...
    public func importPNG(_ sourceURL: URL) throws -> SignatureAsset {
    ...
    public func importPDF(_ sourceURL: URL, pageIndex: Int) throws -> SignatureAsset {
    ...
    public func fileURL(for asset: SignatureAsset) -> URL {
        assetsDirectory.appending(path: asset.managedFilename)
    }

    public func listAssets() throws -> [SignatureAsset] {
