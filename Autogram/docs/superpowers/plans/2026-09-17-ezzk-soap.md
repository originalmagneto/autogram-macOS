...
In `Sources/AutogramKit/EZZK/EZZKService.swift`, replace the whole `public enum EZZKError` declaration (currently lines 51-67) with:
...
Run: `DEVELOPER_DIR="/Applications/Xcode.app/Contents/Developer" swift test --filter EZZKSOAPTransportTests`
Expected: 5 tests pass. The real pinned handshake is checked live in Task 11.
